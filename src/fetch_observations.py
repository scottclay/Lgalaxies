...
def plot_observations(ax,redshift,type):
	...
	if type == "SM_DM":
		if(redshift == 0):
			ax.errorbar(RR_2015['SM'], RR_2015['DM_1'], yerr = (RR_2015['DM_1_down'], RR_2015['DM_1_up']),color='g',label='Remy-Ruyer2015',fmt='.')
			ax.errorbar(np.log10(Bourne_2012['MEDMSTAR']), np.log10(Bourne_2012['MEDMDUST']), yerr = np.log10(Bourne_2012['MEDMDUSTERR']/Bourne_2012['MEDMDUST']) , color='orange',label='Bourne2012',fmt='.')
			ax.errorbar(Ciesla_2014['SM'], Ciesla_2014['DM'], yerr = Ciesla_2014['DM_err'] , color='r',label='Ciesla2014',fmt='.')
			ax.errorbar(Santini_2014['SM_z0'], Santini_2014['DM_z0'], yerr = (Santini_2014['DM_down_err_z0'], Santini_2014['DM_up_err_z0']), color='b',label='Santini2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if(redshift == 1):
			ax.errorbar(Santini_2014['SM_z1'], Santini_2014['DM_z1'], yerr = (Santini_2014['DM_down_err_z1'], Santini_2014['DM_up_err_z1']), color='b',label='Santini2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if(redshift == 2):
			ax.errorbar(Santini_2014['SM_z2'], Santini_2014['DM_z2'], yerr = (Santini_2014['DM_down_err_z2'], Santini_2014['DM_up_err_z2']), color='b',label='Santini2014',fmt='.')
			ax.errorbar(daCunha_2015['SM_z2'], daCunha_2015['DM_z2'], yerr = (daCunha_2015['DM_down_err_z2'], daCunha_2015['DM_up_err_z2']), color='g',label='daCunha2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if(redshift == 3):
			ax.errorbar(daCunha_2015['SM_z3'], daCunha_2015['DM_z3'], yerr = (daCunha_2015['DM_down_err_z3'], daCunha_2015['DM_up_err_z3']), color='b',label='daCunha2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if(redshift == 4):
			ax.errorbar(daCunha_2015['SM_z4'], daCunha_2015['DM_z4'], yerr = (daCunha_2015['DM_down_err_z4'], daCunha_2015['DM_up_err_z4']), color='b',label='daCunha2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if(redshift == 5):
			ax.errorbar(daCunha_2015['SM_z5'], daCunha_2015['DM_z5'], yerr = (daCunha_2015['DM_down_err_z5'], daCunha_2015['DM_up_err_z5']), color='b',label='daCunha2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if(redshift == 6):
			ax.errorbar(daCunha_2015['SM_z6'], daCunha_2015['DM_z6'], yerr = (daCunha_2015['DM_down_err_z6'], daCunha_2015['DM_up_err_z6']), color='b',label='daCunha2014',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
		if( (redshift == 6) or (redshift == 7) ):
			ax.errorbar(Mancini_2015['SM'], Mancini_2015['DM'], yerr = Mancini_2015['DM_err'], xerr = Mancini_2015['SM_err'], color='g',label='Mancini2015',fmt='.')
			ax.legend(loc='lower right',fontsize = 8)
	if type == "DMF":
		if(redshift == 0):
		...
		if(redshift == 0):
			...
			ax.errorbar(RR_2015['SM'], RR_2015['DTG_1B'], yerr=(log_RR_DTG1B_err), color='g',label='Remy-Ruyer+2015',fmt='o') 
			ax.legend(loc='lower right',fontsize = 8)
	elif type == "DTG_Oxy":
		if(redshift == 0):
			RR_DTG1B_err = 10**RR_2015['DTG_1B'] * np.sqrt( (RR_2015['DM_1_up']/RR_2015['DM_1'])**2 + (RR_2015['HI_err']/RR_2015['HI'])**2 )
			log_RR_DTG1B_err =0.434* (np.log10(RR_DTG1B_err)/RR_2015['DTG_1B'])
			ax.errorbar(RR_2015['Oxygen'], RR_2015['DTG_1B'], yerr=(log_RR_DTG1B_err), color='g',label='Remy-Ruyer+2015',fmt='o') 
			ax.legend(loc='lower right',fontsize = 8)
	elif type == "DTM_SM":
		if(redshift == 0):
			ax.errorbar(RR_2015['SM'], RR_2015['DTM_1B'], yerr=(0.75*RR_2015['DTM_1B']), color='g',label='Remy-Ruyer+2015',fmt='o') 
			ax.legend(loc='lower right',fontsize = 8)
	elif type == "DTM_Oxy":
		if(redshift == 0):
			ax.errorbar(RR_2015['Oxygen'], RR_2015['DTM_1B'], yerr=(0.75*RR_2015['DTM_1B']), color='g',label='Remy-Ruyer+2015',fmt='o') 
		if(redshift == 2):
			ax.errorbar(Wiseman_2017['Metals_z2'],np.log10(Wiseman_2017['DTM_z2']*0.464), yerr = np.log10(Wiseman_2017['DTM_err_z2']/Wiseman_2017['DTM_z2']), color='r',label='Wiseman2017',fmt='o')
		if(redshift == 3):
			ax.errorbar(Wiseman_2017['Metals_z3'],np.log10(Wiseman_2017['DTM_z3']*0.464), yerr = np.log10(Wiseman_2017['DTM_err_z3']/Wiseman_2017['DTM_z3']), color='r',label='Wiseman2017',fmt='o')
		if(redshift == 4):
			ax.errorbar(Wiseman_2017['Metals_z4'],np.log10(Wiseman_2017['DTM_z4']*0.464), yerr = np.log10(Wiseman_2017['DTM_err_z4']/Wiseman_2017['DTM_z4']), color='r',label='Wiseman2017',fmt='o')
			ax.legend(loc='lower right',fontsize = 8)
